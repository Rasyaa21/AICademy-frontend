...
const fetchChallengeDetail = async () => {
    ...
    try {
        ...
        const response = await $fetch(`/teacher/challenges/${props.challengeId}`, {
            baseURL: config.public.apiBase,
            credentials: 'include',
            headers
        }) as { success: boolean; data?: ChallengeDetail }
        ...
        const errorMsg = err instanceof Error ? err.message : 'Gagal memuat detail challenge'
...
const fetchChallengeSubmissions = async () => {
    ...
    try {
        ...
        const response = await $fetch(`/teacher/challenges/${props.challengeId}/submissions`, {
            baseURL: config.public.apiBase,
            credentials: 'include',
            headers
        ...
        submissionsError.value = errorMsg
        submissions.value = []
    } finally {
        submissionsLoading.value = false
    }
