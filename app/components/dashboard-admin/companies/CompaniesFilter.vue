        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-4">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    {{ filteredCount }} dari {{ totalCount }} perusahaan ditemukan
                </p>
            </div>
        ...
        <div class="flex flex-col lg:flex-row gap-4">
            ...
            <div class="relative flex-1">
                ...
                <input
                    ...
                    @input="updateSearch"
                    type="text"
                    placeholder="Cari perusahaan berdasarkan nama, email, atau deskripsi..."
            ...
            <div class="relative">
                ...
                >
                    <option value="" class="text-gray-600">Semua Lokasi</option>
            ...
            <div class="flex flex-row space-x-3">
                ...
                >
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-sm">Tambah Perusahaan</span>
                    </div>
                </button>
            </div>
        </div>
