            ...
            <div class="bg-white backdrop-blur-xl flex items-center justify-center rounded-3xl shadow-2xl flex-row overflow-hidden border border-white/20">
                <div class="lg:w-1/2 w-full h-full flex flex-col lg:px-12 px-8 items-center lg:py-8 py-12">
                    <div class="text-center mb-8">
                        ...
                        <h1 class="text-4xl font-bold text-secondary mb-3">Login Sebagai Guru</h1>
                    ...
                    <form @submit.prevent="handleTeacherLogin" class="w-full max-w-md space-y-5">
                        <MainTextfield
                            v-model="form.email"
                            name="email"
                            label="Email"
...
const handleTeacherLogin = () => {
    console.log('Teacher login form:', form.value)
