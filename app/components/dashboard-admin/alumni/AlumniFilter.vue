        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-4">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    {{ filteredCount }} dari {{ totalCount }} alumni ditemukan
                </p>
            </div>
        ...
        <div class="flex flex-col lg:flex-row gap-4">
            ...
            <div class="relative flex-1">
                ...
                <input
                    ...
                    @input="updateSearch"
                    type="text"
                    placeholder="Cari alumni berdasarkan nama, email, atau program..."
            ...
            <div class="relative">
                ...
                >
                    <option value="" class="text-gray-600">Semua Program</option>
...
const updateProgram = (event: Event) => {
    const target = event.target as HTMLSelectElement
    emit('update:selectedProgram', target.value)
}
