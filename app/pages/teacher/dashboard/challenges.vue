...
import ChallengesStatsSection from '~/components/dashboard-teacher/challenges/ChallengesStatsSection.vue'
import ChallengesTableSection from '~/components/dashboard-teacher/challenges/ChallengesTableSection.vue'
import ChallengesEmptyState from '~/components/dashboard-teacher/challenges/ChallengesEmptyState.vue'
import ChallengesPaginationSection from '~/components/dashboard-teacher/challenges/ChallengesPaginationSection.vue'
import ChallengeFilter from '~/components/dashboard-teacher/challenges/ChallengesFilter.vue'
import ChallengeInputPopup from '~/components/modal/teacher/dashboard/challenge/ChallengeInputPopup.vue'
import AlertModal from '~/components/modal/basic-modal/AlertModal.vue'
import ChallengeDetailPopup from '~/components/modal/teacher/dashboard/challenge/ChallengeDetailPopup.vue'
...
// ✅ Fetch data from API - using teacher endpoint
const { data: challengeData, pending, error, refresh } = await useAsyncData('teacherChallengeData', () => 
    $fetch(`/teacher/challenges?${buildApiQuery()}`, {
...
const deleteChallenge = async (challenge: Challenge) => {
    if (confirm('Apakah Anda yakin ingin menghapus challenge ini?')) {
        try {
            await $fetch(`/teacher/challenges/${challenge.id}`, {
                method: 'DELETE',
                baseURL: config.public.apiBase,
                credentials: 'include',
                headers
