  ...
  <div class="flex flex-col space-y-4">
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="text-sm text-gray-500 mt-1">{{ activeChallenges.length }} challenge aktif dari {{ challenges.length }} total</p>
      </div>
      <button class="text-primary hover:text-primary/80 text-sm font-medium">Lihat Semua</button>
    </div>
    ...
    <div class="flex items-center gap-3 mb-2">
      ...
      <button v-if="selectedOrganizer || selectedPrizeFilter" @click="clearFilters" class="px-3 py-2 text-xs font-medium text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-lg transition-colors duration-200 flex items-center gap-1">
